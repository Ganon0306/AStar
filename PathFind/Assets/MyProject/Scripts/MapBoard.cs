...
public class MapBoard : MonoBehaviour
{
    ...
    public List<TerrainControler> GetTerrains_Colum(int xIdx2D, bool isSortReveres)
    {
        ...
        if(terrains.IsValid())
        {
            if(isSortReveres) { terrains.Reverse(); }
            else { }
            return terrains;
        }    
        else { return default; }
    ...
    {
        List<int> idx1D_around2ways = new List<int>();
        ...
        foreach(var idx2D in idx2D_around4ways)
        {
            ...
            idx1D_around2ways.Add(GetTileIdx1D(idx2D));
        }

        return idx1D_around2ways;
